...
/**
 * check97 - checks for the approopriate number of arguments
 * @argc: argument count
 *
 * Return: void
 */
...
/**
 * check98 - checks if the file_from exists and can be read
 * @check: checks if its true or false
 * @file: file_from 
 ...
 * @argv: vector of pointers to the arguments
 *
 * Return: 0 on success
 */
